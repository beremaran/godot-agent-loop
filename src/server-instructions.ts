...
Advanced and hidden capabilities — input primitives, game_eval, game_call_method, game_set_property, game_performance, game_visual_regression, editor_control, and ship tooling such as export_project, verify_export_readiness, analyze_project_integrity, manage_import_pipeline, verify_dotnet_project, and manage_addon — are discoverable via godot_catalog and callable via godot_call.
