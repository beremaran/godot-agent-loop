...
Author project files with your normal file tools; in watched mode, call editor_session ensure and prefer editor_transaction for undoable editor scene mutations. Validate GDScript with run_project_tests or headless checks, then run_project.
