  ...
  },
  {
    ...
    path: makeSlide(2, {
      texts: [
        ...
        { text: 'Claude Sonnet 5  •  high effort\nBuilt-in tools disabled  •  20-tool core surface\nHuman corrections: 0', x: 120, y: 520, size: 34, color: colors.muted },
        { text: 'file authoring', x: 1200, y: 330, size: 44, color: colors.green, bold: true },
        { text: 'launch_editor', x: 1200, y: 420, size: 44, color: colors.green, bold: true },
        { text: 'editor_transaction', x: 1200, y: 510, size: 44, color: colors.green, bold: true },
      ],
    }),
  },
  {
