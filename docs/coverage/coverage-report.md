...
| contract | `tests/loop-latency-report.test.ts`, `tests/runtime-protocol-contract.test.ts`, `tests/source-guardrails.test.ts`, `tests/support-policy.test.ts`, `tests/test-metadata.test.ts`, `tests/tool-coverage.test.ts`, `tests/tool-definitions.test.ts`, `tests/tool-manifest.test.ts`, `tests/tool-mutation-policy.test.ts`, `tests/variant-codec-corpus.test.ts` |
