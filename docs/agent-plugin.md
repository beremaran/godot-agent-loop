...
```bash
codex plugin marketplace add beremaran/godot-agent-loop --ref v1.1.1
codex plugin add godot-agent-loop@godot-agent-loop
```
...
```bash
npx -y @beremaran/godot-agent-loop@1.1.1 setup opencode
npx -y @beremaran/godot-agent-loop@1.1.1 setup opencode --write
npx -y @beremaran/godot-agent-loop@1.1.1 setup opencode uninstall --write
```
